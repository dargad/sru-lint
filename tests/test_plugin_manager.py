...
from sru_lint.common.feedback import SourceLine, SourceSpan
...
class TestPluginManager(unittest.TestCase):
    ...
    def test_load_plugins_with_submodules(
        self,
        mock_getmembers,
        mock_plugins,
        mock_iter_modules,
        mock_import_module,
        mock_launchpad_helper,
    ):
        """Test loading plugins from submodules"""
        mock_launchpad_helper.return_value = MagicMock()

        mock_plugins_module = create_mock_module(
            "sru_lint.plugins", {"DummyPlugin": DummyPlugin, "AnotherPlugin": AnotherPlugin}
        )
        ...
        dummy_plugin_mod = create_mock_module(
            "sru_lint.plugins.dummy_plugin", {"DummyPlugin": DummyPlugin}
        )
        another_plugin_mod = create_mock_module(
            "sru_lint.plugins.another_plugin", {"AnotherPlugin": AnotherPlugin}
        )

        def getmembers_side_effect(module, predicate=None):
            if module is mock_plugins:
                return [("DummyPlugin", DummyPlugin), ("AnotherPlugin", AnotherPlugin)]
    ...
    @patch("sru_lint.plugin_manager.sru_lint.plugins")
    @patch("sru_lint.plugin_manager.inspect.getmembers")
    def test_load_plugins_filters_base_plugin_class(
        self, mock_getmembers, mock_plugins, mock_iter_modules, mock_launchpad_helper
    ):
        """Test that the base Plugin class itself is not instantiated"""
        mock_launchpad_helper.return_value = MagicMock()

        mock_plugins_module = create_mock_module(
            "sru_lint.plugins", {"DummyPlugin": DummyPlugin, "Plugin": Plugin}
        )
        mock_plugins_module.__path__ = ["dummy_path"]
        mock_plugins_module.__name__ = "sru_lint.plugins"
        mock_plugins.__path__ = mock_plugins_module.__path__
        ...
        mock_getmembers.return_value = [("DummyPlugin", DummyPlugin), ("Plugin", Plugin)]
    ...
    @patch("sru_lint.plugin_manager.sru_lint.plugins")
    @patch("sru_lint.plugin_manager.inspect.getmembers")
    def test_load_plugins_filters_non_plugin_classes(
        self, mock_getmembers, mock_plugins, mock_iter_modules, mock_launchpad_helper
    ):
        ...
        mock_plugins_module = create_mock_module(
            "sru_lint.plugins", {"DummyPlugin": DummyPlugin, "NotAPlugin": NotAPlugin}
        )
        mock_plugins_module.__path__ = ["dummy_path"]
        mock_plugins_module.__name__ = "sru_lint.plugins"
        mock_plugins.__path__ = mock_plugins_module.__path__
        ...
        mock_getmembers.return_value = [("DummyPlugin", DummyPlugin), ("NotAPlugin", NotAPlugin)]
    ...
    @patch("sru_lint.plugin_manager.sru_lint.plugins")
    @patch("sru_lint.plugin_manager.inspect.getmembers")
    def test_load_plugins_handles_duplicate_classes(
        self,
        mock_getmembers,
        mock_plugins,
        mock_iter_modules,
        ...
        mock_plugins_module = create_mock_module("sru_lint.plugins", {"DummyPlugin": DummyPlugin})
        mock_plugins_module.__path__ = ["dummy_path"]
        mock_plugins_module.__name__ = "sru_lint.plugins"
        mock_plugins.__path__ = mock_plugins_module.__path__
        mock_plugins.__name__ = mock_plugins_module.__name__

        duplicate_module = create_mock_module(
            "sru_lint.plugins.duplicate_module", {"DummyPlugin": DummyPlugin}
        )
        ...
        mock_iter_modules.return_value = [(None, "sru_lint.plugins.duplicate_module", False)]
    ...
    @patch("sru_lint.plugin_manager.sru_lint.plugins")
    @patch("sru_lint.plugin_manager.inspect.getmembers")
    def test_load_plugins_only_processes_classes(
        self, mock_getmembers, mock_plugins, mock_iter_modules, mock_launchpad_helper
    ):
    ...
    @patch("sru_lint.plugin_manager.sru_lint.plugins")
    @patch("sru_lint.plugin_manager.inspect.getmembers")
    def test_load_plugins_handles_generic_exception(
        self,
        mock_getmembers,
        mock_plugins,
        mock_iter_modules,
        ...
        mock_iter_modules.return_value = [(None, "sru_lint.plugins.error_module", False)]
    ...
    @patch("sru_lint.plugin_manager.sru_lint.plugins")
    @patch("sru_lint.plugin_manager.inspect.getmembers")
    def test_plugin_manager_multiple_calls(
        self, mock_getmembers, mock_plugins, mock_launchpad_helper
    ):
        """Test that multiple calls to load_plugins work correctly"""
        mock_launchpad_helper.return_value = MagicMock()

        create_mock_module("sru_lint.plugins", {"DummyPlugin": DummyPlugin})
