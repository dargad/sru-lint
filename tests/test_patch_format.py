...
class TestPatchFormat(unittest.TestCase):
    ...
    def test_process_file_skips_series_file(self):
        ...
        series_content = ["fix-bug.patch", "upstream-fix.patch", "# This is a comment"]
    ...
    def test_process_file_check_dep3_exception(self, mock_check_dep3):
        ...
        patch_content = ["Malformed patch content", "That causes parsing errors"]
    ...
    def test_feedback_management(self):
        ...
        with patch(
            "sru_lint.plugins.patch_format.check_dep3_compliance",
    ...
    def test_process_integration(self):
        ...
        processed_files = [
            ...
            create_test_processed_file(
                "debian/patches/series", ["good.patch", "bad.patch"]
            ),  # Should be skipped
        ]
